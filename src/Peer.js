...
export const createPeer = pc => setPlaybackVideo => setPlaybackAudio => subscribeVideo => subscribeAudio => () => createPeerImpl(
	pc,
...
export const setSendVideo = peer => sendVideo => () => peer.setSendVideo(sendVideo);
export const setSendAudio = peer => sendAudio => () => peer.setSendAudio(sendAudio);
export const sendMessage = peer => data => () => peer.sendMessage(data);
// eslint-disable-next-line max-len
export const subscribeMessage = peer => subscriber => () => peer.subscribeMessage(data => subscriber(data)());
export const sendRequestImpl = peer => data => () => peer.sendRequest(data);
export const subscribeRequest = peer => subscriber => () => peer.subscribeRequest(
