  ...
  var sendMessage = function (v) {
      return function (message) {
          return function __do() {
              ...
              if (v1 instanceof Data_Either.Right) {
                  return Peer.sendMessage(v1.value0.peer)(message)();
              };
...
(function($PS) {
  ...
  var sendMessage = function (pendingPeer) {
      return function (message) {
          return PendingPeer.sendMessage(pendingPeer)(Data_Argonaut_Core.fromObject(Data_Functor.map(Foreign_Object.functorObject)(Data_Argonaut_Core.fromNumber)(message)));
      };
  };
                          ...
                          return function (set) {
                              ...
                              var setFromKeyboard = function (keyboardStateRef) {
                                  return function (gamepadStateRef) {
                                      return function __do() {
                                          var keyboardState = Effect_Ref.read(keyboardStateRef)();
                                          var $36 = hasKeyboardInputs(keyboardState);
                                          if ($36) {
                                              var upDown = (function () {
                                                  var $37 = Data_Set.member(Data_Ord.ordString)(up)(keyboardState);
                                                  if ($37) {
                                                      return 1.0;
                                                  };
                                                  return 0.0;
                                              ...
                                              var rightDown = (function () {
                                                  var $38 = Data_Set.member(Data_Ord.ordString)(right)(keyboardState);
                                                  if ($38) {
                                                      return 1.0;
                                                  };
                                                  return 0.0;
                                              ...
                                              var leftDown = (function () {
                                                  var $39 = Data_Set.member(Data_Ord.ordString)(left)(keyboardState);
                                                  if ($39) {
                                                      return 1.0;
                                                  };
                                                  return 0.0;
                                              ...
                                              var downDown = (function () {
                                                  var $40 = Data_Set.member(Data_Ord.ordString)(down)(keyboardState);
                                                  if ($40) {
                                                      return 1.0;
                                                  };
                                                  return 0.0;
                                      ...
                                      return function (target) {
                                          return function __do() {
                                              var listener = Web_Event_EventTarget.eventListener(function ($81) {
                                                  ...
                                                  })(Web_PointerEvents_PointerEvent.fromEvent($81))());
                                              })();
              ...
              return function (v1) {
                  return function (control) {
                      return function (v2) {
                          ...
                          throw new Error("Failed pattern match at Operator (line 72, column 5 - line 79, column 49): " + [ v.constructor.name, nextCommandRef.constructor.name, v1.constructor.name, control.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
          };
                      ...
                      return function (set) {
                          ...
                          var setFromKeyboard = function (keyboardStateRef) {
                              return function (gamepadStateRef) {
                                  return function __do() {
                                      var keyboardState = Effect_Ref.read(keyboardStateRef)();
                                      var $67 = hasKeyboardInputs(keyboardState);
                                      if ($67) {
                                          var upDown = (function () {
                                              var $68 = Data_Set.member(Data_Ord.ordString)(up)(keyboardState);
                                              if ($68) {
                                                  return 1.0;
                                              };
                                              return 0.0;
                                          ...
                                          var downDown = (function () {
                                              var $69 = Data_Set.member(Data_Ord.ordString)(down)(keyboardState);
                                              if ($69) {
                                                  return 1.0;
                                              };
                                              return 0.0;
                          ...
                          var addPointerEventListener = function (eventName) {
                              return function (handler) {
                                  return function (target) {
                                      return function __do() {
                                          var listener = Web_Event_EventTarget.eventListener(function ($84) {
                                              return handler((function (x) {
                                                  return function (dictPartial) {
                                                      return Data_Maybe.fromJust()(x);
                                                  };
                                              })(Web_PointerEvents_PointerEvent.fromEvent($84))());
                                          })();
                                          return Web_Event_EventTarget.addEventListener(eventName)(listener)(false)(Web_DOM_Element.toEventTarget(target))();
                                      };
                                  };
                          ...
                          return function __do() {
                              var document = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document)();
                              var actuatorUp = Data_Functor.map(Effect.functorEffect)(function ($85) {
                                  return (function (x) {
                                      return function (dictPartial) {
                                          return Data_Maybe.fromJust()(x);
                                      };
                              ...
                              var actuatorDown = Data_Functor.map(Effect.functorEffect)(function ($86) {
                                  return (function (x) {
                                      return function (dictPartial) {
                                          return Data_Maybe.fromJust()(x);
                                      };
  ...
  var initActuator = function (id) {
      return function (getControl$prime) {
          ...
          return function __do() {
              var document = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document)();
              var up = Data_Functor.map(Effect.functorEffect)(function ($87) {
                  return (function (x) {
                      return function (dictPartial) {
                          return Data_Maybe.fromJust()(x);
                      };
              ...
              var down = Data_Functor.map(Effect.functorEffect)(function ($88) {
                  return (function (x) {
                      return function (dictPartial) {
                          return Data_Maybe.fromJust()(x);
                      };
  ...
  var main = function __do() {
      var peer = PendingPeer.createPendingPeer(Signaling.Operator.value)();
